...
class Map extends CI_Controller {
	...
	public function index() {
		...
		$data['qrcode'] = $this->generateQR('http://dieverdammten.net/fatamorgana/login/skey/'.$this->key);
		$data['bookmark'] = 'http://dieverdammten.net/fatamorgana/login/skey/'.$this->key;		
